module ResourceHelper
  def header_admin_show_button(resource)
    ...
    if policy([:admin, resource]).show?
      link_to(bootstrap_icon("back"), polymorphic_path([:admin, resource]), class: "btn btn-xs btn-outline-secondary")
    end
  end
  ...
  def header_show_button(resource)
    ...
    if policy(resource).show?
      link_to(bootstrap_icon("back"), polymorphic_path(resource), class: "btn btn-xs btn-outline-secondary")
    end
  end
